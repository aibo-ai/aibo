          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
            <div className="flex items-center">
              <Link to="/" className="flex items-center">
                ...
                <span className="ml-3 text-xl font-bold text-primary">ContentArchitect</span>
              </Link>
            </div>
            <div className="flex items-center space-x-4">
              <div className="relative">
                <button className="flex items-center text-neutral-700 hover:text-primary transition-colors">
        ...
        <footer className="bg-neutral-800 text-white py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                <h3 className="text-lg font-semibold mb-4">ContentArchitect</h3>
                <p className="text-neutral-400">AI-powered content generation optimized for LLM search visibility.</p>
              </div>
              <div>
            ...
            <div className="mt-8 border-t border-neutral-700 pt-8 flex flex-col md:flex-row md:justify-between">
              <p className="text-neutral-400">© {new Date().getFullYear()} ContentArchitect. All rights reserved.</p>
